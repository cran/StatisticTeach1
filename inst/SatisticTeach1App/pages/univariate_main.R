...
source("pages/univariate_numerical_summary.R", local = TRUE)

# Load tabular summary tab component  
source("pages/univariate_tabular_summary.R", local = TRUE)

# Load graphical summary tab component
source("pages/univariate_graphical_summary.R", local = TRUE)
